  ...
  return (
    <div className={`relative flex h-screen overflow-hidden bg-[#07030E] text-white ${props.language === "ar" ? "lang-ar" : ""}`}>
      ...
      <div className="relative z-10 flex-1 flex flex-col min-w-0 overflow-hidden bg-gradient-to-br from-[#12081F]/80 via-transparent to-[#1B0E2D]/80">
        <TopCommandBar activeTab={props.activeTab} setActiveTab={props.setActiveTab} privacyMode={props.privacyMode} setPrivacyMode={props.setPrivacyMode} searchQuery={props.searchQuery} setSearchQuery={props.setSearchQuery} onRefresh={props.onRefresh} isRefreshing={props.isRefreshing} language={props.language} />
