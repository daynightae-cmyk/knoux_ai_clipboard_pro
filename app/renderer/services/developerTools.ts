...
export const DEVELOPER_TOOLS: DeveloperToolCard[] = [
  ...
  { id: "secret-scanner", title: "Secret Scanner", description: "Scan text for API keys, tokens, emails, cards, and private-key material.", status: "Active", inputLabel: "Sensitive text", actionLabel: "Scan Secrets", sampleLabel: "Load secret case", copyLabel: "Copy findings", placeholder: "Paste secrets or logs here", sample: "OPENROUTER_API_KEY=sk-or-v1-EXAMPLE_DO_NOT_USE_1234567890\nAuthorization: Bearer qwerty12345678901234567890", outputLabel: "Security findings" },
