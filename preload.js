...
const clipboardApi = Object.freeze({
  ...
  stopMonitoring: () => invokeSafe('clipboard:watch:stop'),
...
contextBridge.exposeInMainWorld('knoux', {
  ...
  security: Object.freeze({
    status: () => invokeSafe('security:status'),
    encrypt: (data, password) => invokeSafe('security:encrypt', data, password),
    decrypt: (payload, password) => invokeSafe('security:decrypt', payload, password),
  }),
  system: Object.freeze({
    ...
    enableAutostart: () => invokeSafe('system:autostart:enable'),
    disableAutostart: () => invokeSafe('system:autostart:disable'),
  }),
  theme: Object.freeze({
